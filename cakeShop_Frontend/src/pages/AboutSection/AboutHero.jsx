...
const AboutHero = () => {
    return (
        <div>
            <CakeNavbar />
            <section className="flex flex-col lg:flex-row lg:h-[85vh]">

                {/* Left Content Side */}
                <div className="w-full px-4 py-5 lg:ps-20 flex flex-col lg:gap-10 gap-5 justify-center">
                    <div className="flex flex-col gap-5 lg:max-w-xl">
                        {/* Header Title */}
                        <h1 className="text-5xl lg:text-7xl text-[#2b0d05]">
                            About
                        </h1>
    ...
    traditional baking techniques to craft unforgettable sweet moments.
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            <button className="bg-[#2b0d05] text-[#fdc700] px-5 py-3 rounded-full font-medium hover:bg-[#fdc700] hover:text-[#2b0d05] transition-colors">
                                Explore Our Cakes
                            </button>

                            <button className="flex items-center gap-2 bg-[#F4F4F4] px-6 py-3 rounded-full font-medium hover:bg-gray-200 transition-colors">
                                <img
                    ...
                    <div className='flex flex-col gap-3 lg:max-w-xl'>
                        <h2 className="text-4xl text-[#2b0d05]">Our values</h2>
    ...
    ensuring every cake meets the highest standards of taste and quality.
                ...
                <div className="w-full px-4 lg:px-0">
                    <img
                        ...
                        className="w-full lg:h-full h-[30vh] md:h-[50vh] rounded-2xl lg:rounded-none object-cover"
                    />
                </div>

...
const DesignerCakeSection = () => {
    ...
    return (
        <div className='relative'>
            <div
                className="absolute inset-0  bg-no-repeat  bg-right opacity-6"
                style={{
            ...
            <div className="w-full px-5 lg:px-16 py-5 lg:py-24 flex flex-col md:flex-row items-center justify-between md:gap-10 bg-white overflow-hidden">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center text-left" data-aos="fade-left">
                    ...
                    <button
                        ...
                        className="bg-[#2a0e05] text-[#fdc700] px-8 py-3.5 rounded-full font-bold transition-transform hover:scale-105 w-max flex items-center justify-center gap-2 shadow-lg"
                    >
                        Shop Now
                        {/* svg / arrow icon */}
